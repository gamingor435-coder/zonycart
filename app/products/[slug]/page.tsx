"use client"; // Client component agar aap hooks use kar rahe hain
// @ts-nocheck
...
export default async function ProductPage({ params }) {
  // TypeScript error se bachne ke liye await params ko handle kiya
    ...
    <main style={{ maxWidth: '1000px', margin: '0 auto', padding: '20px', fontFamily: 'sans-serif' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '50px' }}>
        ...
        <div style={{ flex: '1.2', minWidth: '300px' }}>
          ...
          <p style={{ fontSize: '24px', color: '#B12704', fontWeight: 'bold' }}>Rs. {product.price}</p>
